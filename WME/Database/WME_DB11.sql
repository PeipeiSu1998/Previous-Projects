...
select pt.PalletID, pt.CompanyID, pt.LocationID, pt.PalletHeight, pt.PalletArea, pt.ArrivalDate, DaysStored from Pallet pt, age(ArrivalDate) as DaysStored where 
